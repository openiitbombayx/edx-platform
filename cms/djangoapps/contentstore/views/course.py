...
#Bharatmooc  : for adding institute/organization information
...
def course_listing(request):
    ...
    #Bharatmooc AshutoshB
    #Date Added : 20 October 2014
    #Added to send organization details on index.html page
    Organizations = Organization.objects.all()

    log.info("The index page is called")
	...
	#IITBombayX add and display team member
        'add_team':settings.ALLOW_TEAM_ADD,
...
#Bharatmooc
#Added on : 23September
#Detail: For adding institute co-ordinator
    elif user.is_superuser:
	course_creator_status = 'institute_coordinator'
#Bharatmooc
