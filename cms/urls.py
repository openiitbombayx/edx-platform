...
#Date modified : NA 
#Modified by : NA 
#Description : Added URL for Registration which includes City , State and Pincode fields.

    url(r'^create_account$', 'student.views.create_account', name='create_account'),
    url(r'^activate/(?P<key>[^/]*)$', 'student.views.activate_account', name='activate'),
    url(r'^city_ajax$', 'student.views.city_ajax', name="city_ajax"),
   #IITBombayX urls for serving  Team Members Add/Edit Template
    url(r'^addteam$', 'student.views.add_team',{}, name="add_team"),
    url(r'^editteam$', 'student.views.edit_team',{}, name="edit_team"),
    url(r'^editteamform$', 'student.views.edit_team_form',{}, name="edit_team_form"),
    #IITBombayX urls for serving  Team Members Add/Edit Template
...
#Date modified : NA 
#Modified by : NA 
#Description : For creating organization related information

#    url(r'^create_organization$', 'student.views.create_organization'),
...
'''
#IITBombayX urls for serving  Team Members Photos In Lms
...
#IITBombayX urls for serving  Team Members Photos In Lms ends
'''
