...
STUDIO_SHORT_NAME = "IITBx Studio"
FEATURES = {
...
#IITBombayX Path for uploading Team members Photo
PHOTO_ROOT= "/edx/app/edxapp/media/"
#IITBombayX Path for uploading Team members Photo ends
...
#Bharatmooc 11/November/2014 - Add Organization information
sys.path.append(LMS_ROOT / 'djangoapps')
IMAGES_PATH = LMS_ROOT / "static/images/"
#Bharatmooc
...
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'coursesupport@iitbombayx.in'
DEFAULT_FEEDBACK_EMAIL = 'techsupport@iitbombayx.in'
SERVER_EMAIL = 'adminsupport@iitbombayx.in'
ADMINS = ()
MANAGERS = ADMINS
...
#IITBombayX Flag for Add member Button Visibility In Studio
ALLOW_TEAM_ADD = True
#IITBombayX Flag for Add member Button Visibility In Studio ends
