...
#IITBombayX TickCross Problem 6th August 2015
...
class InputTypeBase(object):
    ...
    def __init__(self, system, xml, state):
        ...
        #IITBombayX TickCross Problem 6th August 2015 starts
        self.due_graded = state.get('due_graded',None)
        self.due_timed = state.get('due_timed',None)
        self.due_answer = state.get('due_answer',None)
        self.last_attempt = state.get('last_attempt',0)
        self.now_attempt = state.get('now_attempt',0)
        #log.info("**************************************************** state:::::")
        #log.info(str(state)) 
        #IITBombayX TickCross Problem 6th August 2015 ends
    ...
    #IITBombayX TickCross Problem 6th August 2015 starts
    def inputtype_context(self):
        """
        Should return a dictionary of keys need to render the template for the input type
        """
        input_context = {
            'due_graded': self.due_graded,
            #'last_attempt': self.last_attempt,
            #'now_attempt': self.now_attempt,
            'due_answer':self.due_answer,
            'due_timed': self.due_timed,
        }
...
class OptionInput(InputTypeBase):
    ...
    def _extra_context(self):
        optioninput_context = {} 
        optioninput_context.update(self.inputtype_context())
        return optioninput_context
    #IITBombayX TickCross Problem 6th August 2015 starts
...
class ChoiceGroup(InputTypeBase):
    ...
    def _extra_context(self):
        #IITBombayX TickCross Problem 6th August 2015 choicegroup context modified
        choicegroupcontext = {
            'input_type': self.html_input_type,
            'choices': self.choices,
            'name_array_suffix': self.suffix
        }
        choicegroupcontext.update(self.inputtype_context())
        return choicegroupcontext
...
class JSInput(InputTypeBase):
    ...
    def _extra_context(self):
        ...
        #IITBombayX TickCross Problem 6th August 2015 
        context.update(self.inputtype_context())
        return context
...
class TextLine(InputTypeBase):
    ...
    def _extra_context(self):
        ...
        textline_context.update(self.inputtype_context())
        return textline_context
...
class CodeInput(InputTypeBase):
    ...
    def _extra_context(self):
        ...
        #IITBombayX TickCross Problem 6th August 2015 starts
        codeinput_context= {'queue_len': self.queue_len, }
        codeinput_context.update(self.inputtype_context())
        return codeinput_context
        #IITBombayX TickCross Problem 6th August 2015 ends
...
class ImageInput(InputTypeBase):
    ...
    def _extra_context(self):
        ...
        imageinput_context.update(self.inputtype_context())
        return imageinput_context
...
class ChemicalEquationInput(InputTypeBase):
    ...
    def _extra_context(self):
        ...
        """
        #IITBombayX TickCross Problem 6th August 2015 
        chemicalequationinput_context = {
            'previewer': '{static_url}js/capa/chemical_equation_preview.js'.format(
                static_url=self.capa_system.STATIC_URL),
        }
        #IITBombayX TickCross Problem 6th August 2015 starts
        chemicalequationinput_context.update(self.inputtype_context())
        return chemicalequationinput_context
        #IITBombayX TickCross Problem 6th August 2015 ends
...
class FormulaEquationInput(InputTypeBase):
    ...
    def _extra_context(self):
        ...
        #IITBombayX TickCross Problem 6th August 2015 starts
        formulaequationinput_context = {
            'previewer': '{static_url}js/capa/src/formula_equation_preview.js'.format(
                static_url=self.capa_system.STATIC_URL),
        }
        formulaequationinput_context.update(self.inputtype_context())
        return formulaequationinput_context
        #IITBombayX TickCross Problem 6th August 2015 ends
...
class DragAndDropInput(InputTypeBase):
    ...
    #IITBombayX TickCross Problem 6th August 2015 starts
    def _extra_context(self):
        draganddropinput_context={}
        draganddropinput_context.update(self.inputtype_context())
        return draganddropinput_context
    #IITBombayX TickCross Problem 6th August 2015 ends
...
class AnnotationInput(InputTypeBase):
    ...
    def _extra_context(self):
        ...
        #IITBombayX TickCross Problem 6th August 2015 
        extra_context.update(self.inputtype_context()) 
        return extra_context
