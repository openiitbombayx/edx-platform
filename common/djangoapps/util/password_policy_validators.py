...
BharatMooc
Dec 31 2014 
created a validation method to check password mismatch and blank password
'''
def validate_password_mismatch(password1,password2):
    if password1 == "" or password2 == "":
        raise ValidationError(_("You must complete all fields."), code="password_blank")
