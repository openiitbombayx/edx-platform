...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Mooc_person'
        db.create_table('student_mooc_person', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['student.Mooc_state'])),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['student.Mooc_city'])),
            ('pincode', self.gf('django.db.models.fields.IntegerField')(max_length=6)),
            ('aadhar_id', self.gf('django.db.models.fields.BigIntegerField')(default=None, max_length=12, null=True, blank=True)),
        ))
        db.send_create_signal('student', ['Mooc_person'])

        # Adding model 'Mooc_city'
        db.create_table('student_mooc_city', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=None, max_length=255)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student.Mooc_state'])),
        ))
        db.send_create_signal('student', ['Mooc_city'])

        # Adding model 'Mooc_state'
        db.create_table('student_mooc_state', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=255, db_index=True)),
        ))
        db.send_create_signal('student', ['Mooc_state'])


    def backwards(self, orm):
        # Deleting model 'Mooc_person'
        db.delete_table('student_mooc_person')

        # Deleting model 'Mooc_city'
        db.delete_table('student_mooc_city')

        # Deleting model 'Mooc_state'
        db.delete_table('student_mooc_state')
    ...
    models = {
        ...
        'student.mooc_city': {
            'Meta': {'object_name': 'Mooc_city'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['student.Mooc_state']"})
        },
        'student.mooc_person': {
            'Meta': {'object_name': 'Mooc_person'},
            'aadhar_id': ('django.db.models.fields.BigIntegerField', [], {'default': 'None', 'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['student.Mooc_city']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pincode': ('django.db.models.fields.IntegerField', [], {'max_length': '6'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['student.Mooc_state']"}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'default': 'None', 'to': "orm['auth.User']", 'unique': 'True'})
        },
        'student.mooc_state': {
            'Meta': {'object_name': 'Mooc_state'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': 'None', 'unique': 'True', 'max_length': '255', 'db_index': 'True'})
        },
