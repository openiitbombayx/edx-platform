...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('student_teammember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=None, max_length=64, db_index=True)),
            ('team_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=64, db_index=True)),
            ('role', self.gf('django.db.models.fields.CharField')(default='None', max_length=32)),
            ('biodata', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, db_index=True)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('student', ['TeamMember'])


    def backwards(self, orm):
        # Deleting model 'TeamMember'
        db.delete_table('student_teammember')
    ...
    models = {
        ...
        'student.teammember': {
            ...
            'biodata': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '64', 'db_index': 'True'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'role': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '32'}),
            'team_name': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '64', 'db_index': 'True'})
        },
        'student.userprofile': {
