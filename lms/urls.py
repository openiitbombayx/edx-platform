...
#    url(r'^register$', 'student.views.register_user', name="register_user"),
    url(r'^how_it_works$', 'student.views.how_it_works', name="how_it_works"),
#Bharat MOOCs 8th Sept new look and feel
    url(r'^make_language/$', 'student.views.make_language', name="make_language"),
    url(r'^show_schoolsayp$', 'student.views.show_schoolsayp', name="show_schoolsayp"),
#IITBombayX add and display team members
    url(r'^member$', 'student.views.team_members', name="member"),

#    url(r'^swayam_courses$', 'student.views.swayam_courses', name="swayam_courses"),
#BharatMooc
#Author: Shiv
#Date: 12 Nov 2014
#Description: For course listing and filtering
    url(r'^all_courses/(?P<coursediff>[0-9A-Za-z]+)$', 'student.views.all_courses', name="all_courses"),

#Bharat MOOCs 8th Sept 2014 For course listing based on university
#    url(r'^courselistbyuniv$', 'courseware.views.get_courses_based_on_university', name="course_list_based_on_univ"),
#Bharat  Mooc
#Ashutosh Bhargave 
#3 september 2014
    #About the organization
    url(r'^organization/(?P<org_id>[^/]+)$','courseware.views.organization_about'),
#Bharat Mooc
#5 September 
# For adding the list of universities or organizations
#31 Dec 2014 : Modified url from school-partners to partners
#IITBombayX May 2016: For removing hard-coding of URLs using MKTG_LINK_MAP
    url(r'^partners','courseware.views.browse_organization'),
...
#Date modified : NA 
#Modified by : NA 
#Description : For creating urls to city_ajax function
    #IITBombayX Commented duplicate
