...
#Bharat MOOCs 9th Sept 2014 : For organization listing
class Organization(models.Model):

      org_id = models.CharField(max_length=255,null=False,default=None)
      org_name = models.TextField(null=False,default=None)
      ...
      url  = models.TextField(null=False,default=None)
      information = models.TextField(null=False,default=None)
      image_name = models.CharField(max_length=255,null=False,default=None)
      header_graphic = models.CharField(max_length=255,null=False,default=None)
      contact_marketing = models.CharField(max_length=255,null=False,default=None)
      contact_course_content = models.CharField(max_length=255,null=False,default=None)
      contact_review_process = models.CharField(max_length=255,null=False,default=None)
      def __unicode__(self):
          return self.org_name

#Bharatmooc
#Date Added : 28th october 2014 
#For different subjects categories
#AshutoshB
class Subject(models.Model):
        subject_name = models.CharField(max_length=255,null=False,default=None)

        def __unicode__(self):
          return self.subject_name

#Bharatmooc :End For different subjects categories

#Bharatmooc
#Date Added : 28th october 2014 
#For course and subjects mapping
#AshutoshB
class Course_subject(models.Model):

      course_id = models.CharField(max_length=255,null=False,default=None)
      course_name = models.CharField(max_length=255,null=False,default=None)
      subject_id = models.IntegerField(default=0)

      def __unicode__(self):
          return self.course_name
#Bharat MOOCs :End For course and subjects mapping
