...
def send_email(request, course_id):
    ...
    #BharatMOOCs 10th Feb 2015 added configuratin setting for bulk email template and from address in case microsite not configured
    # functionality is accessible from instructor dashboard
    if template_name == None:
	template_name = settings.COURSE_EMAIL_TEMPLATE_NAME
    if from_addr == None:
	from_addr = settings.COURSE_EMAIL_FROM_ADDR
    #BharatMOOCs 10th Feb 2015 ends
