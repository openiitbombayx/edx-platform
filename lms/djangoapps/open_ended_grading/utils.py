...
STAFF_ERROR_MESSAGE = _("Error occurred while contacting the grading service.  Please notify your IITBombayX point of contact.")
...
def create_controller_query_service():
    """
    Return an instance of a service that can query IITBombayX ORA.
    """
...
class StudentProblemList(object):
    ...
    def __init__(self, course_id, user_id):
        ...
        # Create a service to query IITBombayX ORA.
    ...
    def add_problem_data(self, base_course_url):
        ...
        for problem in self.problem_list:
            ...
            grader_type_display_name = GRADER_DISPLAY_NAMES.get(problem['grader_type'], "IITBombayX Assessment")
