...
"""
IITBombayX 9th Jan 2016; changes relating to validation approach changed in Cypress
"""
...
class FormDescription(object):
    ...
    def add_field(
        ...
        options=None, include_default_option=False, error_messages=None,autocomplete=u""
    ):
