...
#IITBombayX added PINCODE_MIN_LENGTH,PINCODE_MAX_LENGTH CITY_MIN_LENGTH AADHAR_MIN_LENGTH AADHAR_MAX_LENGTH
#IITBombayX : Modified the display text of web pages in many places across the file
from .accounts import (
    NAME_MAX_LENGTH, EMAIL_MIN_LENGTH, EMAIL_MAX_LENGTH, PASSWORD_MIN_LENGTH, PASSWORD_MAX_LENGTH,
    USERNAME_MIN_LENGTH, USERNAME_MAX_LENGTH,PINCODE_MIN_LENGTH,PINCODE_MAX_LENGTH,CITY_MIN_LENGTH,AADHAR_MIN_LENGTH,AADHAR_MAX_LENGTH
)
from .accounts.api import check_account_exists
#IITBombayX added StateSerialiazer
from .serializers import UserSerializer, UserPreferenceSerializer,StateSerialiazer
import logging
log= logging.getLogger("__IITBombayX__")
...
class LoginSessionView(APIView):
	...
	# IITBombayX
        email_instructions = _(
            u"This is the e-mail address you used to register with {platform_name}"
...
class RegistrationView(APIView):
    ...
    EXTRA_FIELDS = [
        #IITBombayX added state and city
        "state",
        "city",
        "country",
        #IITBombayX added pincode & aadhar_id
        "pincode",
        "aadhar_id",
        "gender",
        "year_of_birth",
    ...
    def _add_name_field(self, form_desc, required=True):
        ...
        name_placeholder = _(u"Piyush Sharma")
    ...
    def _add_username_field(self, form_desc, required=True):
        ...
        username_placeholder = _(u"PiyushSharma")
   ...
   #IITBombayX added field pincode
    def _add_pincode_field(self, form_desc, required=True):
        """Add an pincode  field to a form description.
        ...
        # Translators: This label appears above a field on the registration form
        # meant to hold the user's email address.
        pincode_label = _(u"Pincode")

        # Translators: This example email address is used as a placeholder in
        # a field on the registration form meant to hold the user's email address.
        pincode_placeholder = _(u"123456")
    ...
    def _add_state_field(self, form_desc, required=True):
        ...
        form_desc.add_field(
            ...
            label=state_label,
            field_type="select",
            options=StateSerialiazer.get_state(),
            include_default_option=True,
            required=required
        )

 
   #IITBombayX added field city 
...
#IITBombayX added field aadhar_id
    def _add_aadhar_id_field(self, form_desc, required=False):
        """Add an aadhar  field to a form description.
        ...
        # Translators: This label appears above a field on the registration form
        # meant to hold the user's email address.
        aadhar_label = _(u"Aadhar ID (UIDAI)")

        # Translators: This example email address is used as a placeholder in
        # a field on the registration form meant to hold the user's email address.
        aadhar_placeholder = _(u"123456789012")

        form_desc.add_field(
            "aadhar_id",
            field_type="text",
            label=aadhar_label,
            placeholder=aadhar_placeholder,
            restrictions={
                "min_length": AADHAR_MIN_LENGTH,
                "max_length": AADHAR_MAX_LENGTH,
