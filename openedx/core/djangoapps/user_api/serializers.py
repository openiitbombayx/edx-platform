...
#IITBombayX added Mooc_state
from student.models import UserProfile,Mooc_state
...
#IITBombayX New class added for state
class StateSerialiazer(object):
      @staticmethod
      def get_state():
         return tuple([(pref.id, pref.name) for pref in Mooc_state.objects.all()])
